...
DROP PROCEDURE ELIMINAR_USUARIOS;
...
SELECT  A.COD_PACIENTE,A.NOMBRES,A.APELLIDOS,A.CELULAR1,B.FECHA_PAGO,
B.ID_PAGO,C.TRATAMIENTO,C.PRECIO,B.PAGO,B.SALDO,B.USUARIO,B.NO_RECIBO, C.COD_PRESUPUESTO 
FROM TB_PACIENTES A, TB_PAGOS B, TB_PRESUPUESTO  C 
WHERE A.COD_PACIENTE=B.COD_PACIENTE AND B.NO_RECIBO=1 AND A.COD_PACIENTE=C.COD_PACIENTE
