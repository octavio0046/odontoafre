    ...
    <html>
        <div class="cabecera">
            ...
            <%@include file="template1.jsp" %>
               <%@include file="obtenerPagosPresupuesto.jsp" %>
        </div>
        <div class="contenido">
            <center>
                ...
                <br><th><a href="obtenerPagosPresupuesto.jsp?cod=<%= d.getCodigo()%>"
                       target="detalle" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenterP" >Ver Pagos</a></th>
                </table>
