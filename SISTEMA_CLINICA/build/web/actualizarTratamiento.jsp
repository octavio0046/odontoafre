        ...
        <center>
            ...
            <form action="ServletTratamientos" method="post">
                <table border="0" width="400" align="center">
                    <input type="text" name="txtCodigoPaciente" value="<%=d.getCodigo_paciente()%>" hidden="">
                    <tr>
                        ...
                        <td><input type="text" style="text-transform:uppercase; height: 100px; width: 350px;"  onkeyup="javascript:this.value = this.value.toUpperCase();" name="txtPresupuesto" value="<%=d.getTratamiento()%>"></td>

                    </tr> <tr>
                        <td>Precio Total del Tratamiento</td>
                        <td><input type="number" name="txtPrecio" value="<%=d.getPrecio()%>"></td>
                    ...
                    <tr>
                        <th colspan="2"><input type="submit" value="Actualizar" name="btnActualizar" class="btn btn-info"/></th>
                    </tr>
